...
<script>
    ...
    function handleClick(e){
        ...
        // changed clicked elements content from - to +
        const shrinkNav = e.target;
        shrinkNav.innerHTML = shrinkNav.innerHTML === '−' ? '+' : '−';
    }
...
<div class="external-content">
    <div class="floating-nav">
        ...
        <div class="nav-title">
            ...
            <button class="expender" on:click={(e)=>handleClick(e)}><div class="shrink-nav">&#8722;</div></button>
        </div>
