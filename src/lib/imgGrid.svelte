    ...
    {:then observations} 
        {#if screenWidth > 720 }
            {#each observations as observation,i}
                <div class="my-coast">
                    <img src={observation.properties.picUrl} alt="Coastal Flooding Reference {observation.properties.title.replace("Photo Station report from ","").replace("High Water report from ","")}"/>
